...
const MaritalStatusPage = () => {
  ...
  const items = ["Single", "Married", "Widowed"];
    ...
    >
      <div className="px-12 py-4">
        <div className="flex items-center">
          ...
          <h2 className="text-3xl text-white font-medium">Marital Status</h2>
        </div>

        <Well className="mt-8 px-8 py-8 border-none bg-darkmode-900">
          <h3 className="text-base text-white mb-5">Marital Status List</h3>
          <ul className="flex">
        ...
        <Well className="mt-8 p-8 border-none bg-darkmode-900">
          <span className="text-xs text-white font-light">Add Marital Status</span>
