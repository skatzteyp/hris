...
const PreEmploymentRequirementPages = () => {
  const history = useHistory();
  const [modules, setModule] = useModules();
  const items = ["NBI Clearance", "1x1 Photo", "X-Ray", "SSS Number", "TIN Number"];
    ...
    >
      <div className="px-12 py-4">
        <div className="flex items-center">
          ...
          <h2 className="text-3xl text-white font-medium">Pre-Employment Requirements</h2>
        </div>

        <Well className="mt-8 px-8 py-8 border-none bg-darkmode-900">
          <h3 className="text-base text-white mb-5">Pre-Employment Requirement List</h3>
          <ul className="flex">
        ...
        <Well className="mt-8 p-8 border-none bg-darkmode-900">
          <span className="text-xs text-white font-light">Add Pre-Employment Requirement</span>
          <div className="flex relative mt-2">
            <div className="mr-6 w-1/2">
              <Text
                placeholder="Type Pre-Employment Requirement"
...
export default PreEmploymentRequirementPages;