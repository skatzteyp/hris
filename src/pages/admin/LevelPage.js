...
const LevelPage = () => {
  ...
  const items = ["Junior", "Middle", "Senior", "Junior-Middle", "Middle-Senior", "Managerial"];
    ...
    >
      <div className="px-12 py-4">
        <div className="flex items-center">
          ...
          <h2 className="text-3xl text-white font-medium">Level</h2>
        </div>

        <Well className="mt-8 px-8 py-8 border-none bg-darkmode-900">
          <h3 className="text-base text-white mb-5">Job Level List</h3>
          <ul className="flex">
        ...
        <Well className="mt-8 p-8 border-none bg-darkmode-900">
          <span className="text-xs text-white font-light">Add Job Level</span>
          <div className="flex relative mt-2">
            <div className="mr-6 w-1/2">
              <Text
                placeholder="Type Job Level"
